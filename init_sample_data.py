...
from app.models import Drink, Guest
...
def copy_sample_images():
    ...
    try:
        ...
        print(
            "Could not import create_placeholder_images module. Using fallback method."
        )
    ...
    with app.app_context():
        ...
        sample_drinks = [
            ...
            Drink(
                ...
                abv=40.0,
                volume_ml=45,
                image_path="images/drinks/vodka.png",
            ),
            Drink(
                name="Margarita",
                abv=15.0,
                volume_ml=200,
                image_path="images/drinks/margarita.png",
            ),
            Drink(
                name="Gin & Tonic",
                abv=10.0,
                volume_ml=240,
                image_path="images/drinks/gin_tonic.png",
            ),
            Drink(
                name="Rum & Coke",
                abv=12.0,
                volume_ml=240,
                image_path="images/drinks/rum_coke.png",
            ),
            Drink(
                name="Hard Seltzer",
                abv=5.0,
                volume_ml=355,
                image_path="images/drinks/seltzer.png",
            ),
        ]
